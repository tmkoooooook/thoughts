...
ActiveRecord::Schema.define(version: 2021_08_07_052200) do
  ...
  create_table "thoughts", charset: "utf8", force: :cascade do |t|
    t.string "title", limit: 50, null: false
    t.text "text", null: false
    t.string "shorted_text", limit: 100, null: false
    t.bigint "user_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  add_foreign_key "relationships", "users", column: "interest_id"
